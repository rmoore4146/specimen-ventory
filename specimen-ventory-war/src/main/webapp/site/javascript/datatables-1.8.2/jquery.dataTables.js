...
(function($, window, document) {
	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			 ...
			 * Scope:    jQuery.dataTable.classSettings
			 *
			 * +++VBMS change: new default is 10 years.
			 */
			this.iCookieDuration = 60 * 60 * 24 * 365 * 10;
		...
		this.fnSetColumnVis = function ( iCol, bShow, bRedraw )
		{
			...
			//There's no sense in updating because we are going to do an ajax
			//request and refresh the display that way.
			//If we don't do this, we get junk in workQueue when showing
			//and hiding columns
            if (!oSettings.bServerSide){
		...
		function _fnSortAttachListener ( oSettings, nNode, iDataIndex, fnCallback )
		{
			$(nNode).bind( 'click.DT', function (e) {
                ...
                // Hack to fix 96564
                // Probably not neccessary if datatables is updated to newest version
                // If we are resizing, don't do anything
